...
export const createTask = async (payload: { description: string; authorId: string }): Promise<Task> => {
...
export const updateTask = async (taskId: string, updates: Partial<Pick<Task, 'description' | 'complete'>>
): Promise<Task> => {
